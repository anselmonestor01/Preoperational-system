  ...
  if (!round) {
    return (
      <div className="driver-shell">
        <div className="d-body" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "70vh" }}>
          <div className="stub">
            <h3>Sin ronda abierta</h3>
            <p>
              No hay una ronda de inspección abierta. Solicite a administración que inicie una ronda
              desde el panel (Rondas → Abrir ronda).
            </p>
